...
public class ToCreatePurchaseOrderWithItemAndAddServiceTest extends BaseClass {
	...
	public void cratePurchaseOrderTest() throws Throwable {
	 ...
	 //	String subject= wb.getSheet("sheet1").getRow(16).getCell(2).getStringCellValue();
		...
		cPurchaseOrderPage.enterPurchaseOrderDetails(driver,subject,vendor_name, billing_address, product_name, service_name);
